...
<div class="flex flex-col min-h-screen">
  <div class="">
    ...
    <div class="flex justify-center border-t  py-5">
      <a href="#" class="mx-4 p-2 px-4 border-2 bg-gray-900 text-white border-white rounded-lg hover:text-white hover:bg-gray-800 cursor-pointer">Articles</a>
