...
const Quizzes = (props) => {
  ...
  return(
    <div>
      <Head>
        <title>Quizzes Page -codeaddon</title>
      </Head>
{/* //------------------- */}
...
<div className="shadow">
  ...
  <h1  className="bg-sky-300 px-2 ">T</h1>
      ...
      <h1 className="font-bold text-5xl text-white leading-tight mt-3 mb-6 pt-5">under maintenance!</h1>
...
<div className=" p-5">
  ...
  <h1  className="bg-sky-300 px-2 ">T</h1>
    ...
    <figcaption className=" text-lg -mt-16 text-white px-4 pt-12 block md:hidden z-40">


<div className="shadow py-5 pl-5  mr-6 pr-7 bg-gray-800">
  <br/>
      <h1 className="font-bold text-4xl text-white leading-tight  text-shadow-lg pl-10 pt-10 pb-2	">under maintenance!</h1>
...
<div className="flex flex-col min-h-screen md:px-3">
  <div className="">
    ...
    <div className="flex justify-center  ">
      ...
      <h2 className=' py-2  font-bold text-4xl text-gray-900 '> Latest Atricles </h2>
    </div>
  </div>
